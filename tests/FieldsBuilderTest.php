...
use Tsp\AcfBuilder\GroupBuilder;

class FieldsBuilderTest extends \PHPUnit_Framework_TestCase
{
    public function testClassExists()
    {
        $this->assertTrue(class_exists('Tsp\AcfBuilder\FieldsBuilder'));
    }
    ...
    public function testInstantiation()
    {
        ...
        $this->assertTrue(is_a($builder, 'Tsp\AcfBuilder\FieldsBuilder'));
    }
    ...
    {
        $builder = $this->getMockBuilder('Tsp\AcfBuilder\FieldsBuilder')
    ...
    {
        $this->expectException(\Tsp\AcfBuilder\FieldNotFoundException::class);
    ...
    {
        $this->expectException(\Tsp\AcfBuilder\ModifyFieldReturnTypeException::class);
    ...
    public function testGroupFieldReturnsGroupBuilder()
    {
        ...
        $this->assertInstanceOf('\Tsp\AcfBuilder\GroupBuilder', $builder->addGroup('background'));
    }

    public function testRelationshipFieldSupportsBidirectionalHelper()
    {
        $builder = new FieldsBuilder('Banner');
        $builder
            ->addRelationship('related_posts')
            ->enableBidirectional(['field_related_content', ' field_featured_in ']);
        ...
        $this->assertArraySubset([
            'fields' => [
                [
                    ...
                    'type' => 'relationship',
                    'bidirectional' => 1,
                    'bidirectional_target' => ['field_related_content', 'field_featured_in'],
                ],
            ],
        ], $builder->build());
    }
